...
namespace ImageFilters.Library.Imager.Filters; 

internal class libXBRz {

  public class ScaleSize {
    public static readonly ScaleSize TIMES2 = new(_SCALER2_X);
    public static readonly ScaleSize TIMES3 = new(_SCALER3_X);
    public static readonly ScaleSize TIMES4 = new(_SCALER4_X);
    public static readonly ScaleSize TIMES5 = new(_SCALER5_X);
  ...
  private static readonly ScalerCfg _CONFIGURATION = new();
...
*/
  ...
  private class ColorEqA : IColorEq {
    ...
    public bool _(sPixel col1, sPixel col2) {
      return _ColorDist(col1, col2, _CONFIGURATION.luminanceWeight) < _eqColorThres;
    }
  }
  ...
  internal class OutputMatrix {
    ...
    public OutputMatrix(int scale, sPixel[] output, int outWidth) {
      _n = (scale - 2) * _MAX_ROTS * _MAX_SCALE_SQUARED;
      _output = new ImagePointer(output);
      _outWidth = outWidth;
    }

    public void Move(RotationDegree rotDeg, int outi) {
      _nr = _n + (int)rotDeg * _MAX_SCALE_SQUARED;
      _outi = outi;
    }

    public ImagePointer Reference(int i, int j) {
      var rot = _MATRIX_ROTATION[_nr + i * _MAX_SCALE + j];
      _output.Position(_outi + rot.Item2 + rot.Item1 * _outWidth);
      return _output
        ;
    }
  }
  ...
  internal class ImagePointer {
    ...
    public sPixel GetPixel() {
      return _imageData[_offset];
    }

    public void SetPixel(sPixel val) {
      _imageData[_offset] = val;
    }
  }
